...
class ZendBasics_Form_Register_NewMember extends Zend_Form {
	...
	public function init() {
		...
		$this->setElementDecorators(array('ViewHelper', 
																			array('Errors', array('class' => 'alert alert-danger form-alert')), 
		...
		$this->addElement('text', 'nickname', array(
			...
			'required'   => true ));
		$this->getElement('nickname')->class = 'form-control';
		...
		$this->addElement('text', 'email', array(
			...
			'required'   => true ));
		$this->getElement('email')->class = 'form-control';
		...
		$this->addElement('password', 'password', array(
			...
			'required'   => true ));
		$this->getElement('password')->class = 'form-control';
		...
		$this->addElement('password', 'password_confirm', array(
			...
			'required'   => true, ));
		$this->getElement('password_confirm')->class = 'form-control';
