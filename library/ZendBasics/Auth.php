...
class ZendBasics_Auth extends Zend_Auth {
	...
	public static function isAuthenticated($post = array()) {
		...
		$adapter = new ZendBasics_Auth_Adapter_DbTable(Zend_Db_Table_Abstract::getDefaultAdapter());
	...
	public static function initAuth() {
		self::getInstance()
						->setStorage(new Zend_Auth_Storage_Session(ZendBasics_Constants::SESSION_NAMESPACE));
	}
}
